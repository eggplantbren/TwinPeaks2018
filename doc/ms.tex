...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.75]{figures/demo_canonical.pdf}
\caption{Three canonical distributions for different values of the two
temperatures $T_1$ and $T_2$. These are for the one-dimensional case, but
in this example, the 100 dimensional canonical distributions are independent
and have these distributions as their marginals.\label{fig:demo_canonical}}
\end{figure}
...
Figure~\ref{fig:demo_truth} as a function of two temperatures.
